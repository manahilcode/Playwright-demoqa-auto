...
export async function clickAllDropdowns(page: Page): Promise<void> {
  ...
  await page.locator(selectors.Selectmenu).waitFor({ state: 'visible', timeout: 10000 });
  ...
  await page
    .locator('//div[contains(@id, "react-select") and text()="Group 2, option 1"]')
    .click();
